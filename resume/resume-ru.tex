...
\section{Проекты}
  \resumeSubHeadingListStart
    \resumeSubItem{\href{https://github.com/timryadovouu/cape}{cape}}
      {Нативная утилита для macOS, превращающая пространство вокруг выреза камеры в интерактивный хаб в духе Dynamic Island: таймер, буфер обмена, управление музыкой, to-do, учёт экранного времени и голосовой ввод на устройстве. Swift, SwiftUI, AppKit.}
