...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\href{https://timryadovouu.github.io}{\Large Рядовой Тимофей Сергеевич}} & Почта : \href{mailto:timaryadovou@yandex.ru}{timaryadovou@yandex.ru}\\
...
\section{Образование}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Магистратура — «Системы и технологии технического зрения» (Передовая инженерная школа)}{Сен. 2026 -- н.в.}
    \resumeSubheading
      {Университет ИТМО}{Санкт-Петербург}
      {Бакалавриат — «Конструирование и технология электронных средств»; средний балл: 4.38}{Сен. 2021 -- Июнь 2026}
...
\section{Навыки}
 \resumeSubHeadingListStart
   \item{
     \textbf{Языки программирования}{: Python, SQL, JavaScript, C, Bash}
   }
   \item{
